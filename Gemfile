...
gem 'puma-plugin-statsd', '~> 2.1', '>= 2.1.0'
...
group :test do
  ...
  gem 'rspec-rails', '~> 5.0.3', group: :development
  ...
  gem 'json_spec', '~> 1.1.4'
  gem 'shoulda-matchers', '~> 5.1', '>= 5.1.0', require: nil
...
group :development, :test do
  ...
  gem 'rack-mini-profiler', '>= 2.3.4', require: false
